...
export class MainComponent {
  ...
  public words = [
    ...
    { text: 'weeks', value: 11 },
    { text: 'few', value: 12 },
    { text: 'conclusion', value: 11 },
    { text: 'seen', value: 12 },
    { text: 'risk', value: 19 },
    { text: 'country', value: 16 },
    { text: 'states', value: 17 },
    { text: 'being', value: 13 },
    { text: 'president', value: 18 },
    { text: 'out', value: 15 },
    { text: 'back', value: 15 },
    { text: 'people', value: 24 },
    { text: 'speak', value: 12 },
    { text: 'everyone', value: 18 },
  ];
  public portfolio: Array<Portfolio> = [
    {
      ...
      type: '1',
      scale: this.portfolioScale,
    },
    {
      name: 'Consumer Staples',
      percent: this.percents[1],
      type: '1',
      scale: this.portfolioScale,
    },
    {
      name: 'Energy',
      percent: this.percents[2],
      type: '1',
      scale: this.portfolioScale,
    },
    {
      name: 'Financials',
      percent: this.percents[3],
      type: '1',
      scale: this.portfolioScale,
    },
    {
    ...
    {
      name: 'Industrials',
      percent: this.percents[5],
      type: '1',
      scale: this.portfolioScale,
    },
    {
      name: 'Materials',
      percent: this.percents[6],
      type: '1',
      scale: this.portfolioScale,
    },
    {
      name: 'Real Estate',
      percent: this.percents[7],
      type: '1',
      scale: this.portfolioScale,
    },
    {
      name: 'Technology',
      percent: this.percents[8],
      type: '1',
      scale: this.portfolioScale,
    },
    {
      name: 'Communication Services',
      percent: this.percents[9],
      type: '1',
      scale: this.portfolioScale,
    },
    {
      name: 'Utilities',
      percent: this.percents[10],
      type: '1',
      scale: this.portfolioScale,
    },
  ];
